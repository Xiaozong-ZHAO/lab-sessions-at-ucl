...
def simulate_with_given_pid_values(sim_, kp, kd, joints_id, regulation_displacement=0.1, episode_duration=20, plot=False):
    ...
    plt.plot(q_mes_all, label='Joint Position')
...
if __name__ == '__main__':
    ...
    kp = 12.8
    kd = 2.46
    data=simulate_with_given_pid_values(sim,kp,kd,joint_id,regulation_displacement=1,episode_duration=20,plot=False)
